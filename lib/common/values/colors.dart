...
class AppColors {
  ...
  static const Color socialSuYesili = Color(0xFFBADFB8);

  static const Color socialAcikGri = Color(0xFFF9F9F9);

  static const Color socialBeyaz = Color(0xFFFFFFFF);

  static const Color socialLacivert = Color(0xFF2A3360);

  static const Color soicalKoyuLacivert = Color(0xFF19224C);
